...
# ==================== MS4 PART 4 START ====================
# Terminal GUI (text user interface) for the RISC-V simulator.
# This uses only Bash and standard terminal commands, so it does not require
# Tkinter, Qt, GTK, ncurses development files, or any external packages.
# ===================== MS4 PART 4 END =====================
...
find_default_input() {
    local candidate
    for candidate in \
        code/ms4/input/branch_predictor_2bit.input \
        code/ms4/input/branch_predictor_1bit.input \
        code/ms4/input/icache_basic.input \
